        ...
        <div className="row">
          <div className="col-12">
            ...
            <div>
              ...
              <StyledContainer>
                <Button className='mr-4' block='sm'>Responsive button on sm (<strong>{GRID_BREAKPOINTS.sm}</strong>)</Button>
                <Button block='md' btn-style='secondary'>Responsive button on md (<strong>{GRID_BREAKPOINTS.md}</strong>)</Button>
              </StyledContainer>
            </div>
